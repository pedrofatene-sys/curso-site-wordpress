...
const channels = [
    ...
    { id: 'kNABhDkuZ0o', name: 'Ferramentas úteis para desenvolvedores' },
    { id: '5KwiBuTtR0o', name: 'CSS Peeper: uma ferramenta muito útil para criar sites' },
    { id: 't4sLUmejkUU', name: 'Evolução do WordPress (parte 2)' },
    { id: 't4sLUmejkUU', name: 'Evolução do WordPress (parte 2)' },
    { id: 't4sLUmejkUU', name: 'Evolução do WordPress (parte 2)' },
    { id: 't4sLUmejkUU', name: 'Evolução do WordPress (parte 2)' },
    { id: 't4sLUmejkUU', name: 'Evolução do WordPress (parte 2)' },
    { id: 't4sLUmejkUU', name: 'Evolução do WordPress (parte 2)' },
    { id: 'A8_l9hLDiv0', name: 'Configurações importantes' },
    { id: 't4sLUmejkUU', name: 'Evolução do WordPress (parte 2)' },
    { id: 't4sLUmejkUU', name: 'Evolução do WordPress (parte 2)' },
    { id: 't4sLUmejkUU', name: 'Evolução do WordPress (parte 2)' },
    { id: 't4sLUmejkUU', name: 'Evolução do WordPress (parte 2)' },
